            ...
            if(field.type === 'Textarea') {
                return (
                    <div key={index} className="form-group">
                        ...
                        <textarea defaultValue={field.defaultValue} placeholder={field.placeholder} className="form-control"
                ...
                return (
                    <p key={index} className="form-group">
                        <label className="label" htmlFor={field.title}>{field.title}</label>
                        <input defaultValue={field.defaultValue} placeholder={field.placeholder} className="date_picker form-control"
                ...
                return (
                    <p key={index} className="form-group">
                        <label className="label" htmlFor={field.title}>{field.title}</label>
                        <input defaultValue={field.defaultValue} placeholder={field.placeholder} className="time_picker form-control"
                               type='text' readOnly={field.validation.isReadOnly} required={field.validation.isRequired}/>
                    </p>
                );
            }else{
                return (
                    <div key={index} className="form-group">
                        ...
                        <input  placeholder={field.placeholder} className="form-control"
                               type={field.type} defaultValue={field.defaultValue} readOnly={field.validation.isReadOnly} required={field.validation.isRequired}/>
                    </div>
                );
            }
